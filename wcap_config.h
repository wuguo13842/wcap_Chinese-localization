		...
		{
			{
				...
				.Items = (Config__DialogItem[])
				{
					...
					{ L"显示边界框  [&B]",                ID_SHOW_RECORDING_BORDER, ITEM_CHECKBOX                     },
					{ L"窗口圆角  [&R]",                ID_ROUNDED_CORNERS,       ITEM_CHECKBOX                     },
			...
			},
			{
				...
				.Items = (Config__DialogItem[])
				{
					{ L"开启捕获(全部)  [&D]",            ID_AUDIO_CAPTURE,           ITEM_CHECKBOX     },
					{ L"仅应用音频  [&N]",        ID_AUDIO_APPLICATION_LOCAL, ITEM_CHECKBOX     },
